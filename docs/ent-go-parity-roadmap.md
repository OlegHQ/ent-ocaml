...
7. Eager loading and named edges:
   ...
   `Edge_chain`. Full nested eager-loading trees with intermediate-node
   materialization and optional bidirectional backrefs remain.
