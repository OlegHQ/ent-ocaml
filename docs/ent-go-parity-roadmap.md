...
- `[@@deriving ent]` generation for entity metadata, functional query helpers,
  ...
  equality, comparison, membership, and null checks.
...
| JSON predicates | Generated nested path predicates implemented for `[@ent.json]` fields | Dotted paths and aggregation expressions |
